...
<section id="main_content" class="bg slice-sm sct-color-1">
    <div class="container" id="container">
        ...
        <div class="breadcrumb-pageheader">
            ...
            <h6 class="sm-pagetitle--style-1 has_page_title">DataTables Blog Category</h6>
        </div>
        <!--END BREADCRUMB-->
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td>
                                                    <form action="{{action('BlogcategoryController@destroy',        $blogcategory->id) }}" method="Post">
                                                        ...
                                                        {{ csrf_field() }}
                                                        <a class="btn btn-warning" href="{{action('BlogcategoryController@edit',        $blogcategory->id) }}">Edit</a>
