    ...
    <div class="container" id="container">
        ...
        <div class="breadcrumb-pageheader">
            <ol class="breadcrumb sm-breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Add New Index Data Form</li>
            </ol>
            <h6 class="sm-pagetitle--style-1 has_page_title">Add New Index Data Form</h6>
        </div>
									...
									<div class="row">
		                                <div class="col-12">
		                                    <div class="form-group">
		                                        ...
		                                        <input name="project" placeholder="Example 10++ "
		                                               type="text" class="form-control">
		                                    </div>
		                                </div>
		                            </div>
		                            ...
		                            <div class="row">
		                                <div class="col-12">
		                                    <div class="form-group">
		                                        ...
		                                        <input name="staff" placeholder="Example 10++ "
		                                               type="text" class="form-control">
		                                    </div>
		                                </div>
		                            </div>
		                            ...
		                            <div class="row">
		                                <div class="col-12">
		                                    <div class="form-group">
		                                        ...
		                                        <input name="investment" placeholder="Example 10++ "
		                                               type="text" class="form-control">
		                                    </div>
		                                </div>
		                            </div>
		                            ...
		                            <div class="row">
		                                <div class="col-12">
		                                    <div class="form-group">
		                                        ...
		                                        <input name="taxation" placeholder="Example 10++ "
		                                               type="text" class="form-control">
		                                    </div>
		                                </div>
		                            </div>
