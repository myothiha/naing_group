    ...
    <div class="container" id="container">
        ...
        <div class="breadcrumb-pageheader">
            <ol class="breadcrumb sm-breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Project Type Form</li>
            </ol>
            <h6 class="sm-pagetitle--style-1 has_page_title">Edit Project Type Form</h6>
        </div>
		        ...
		        <div class="row">
		            <div class="col-lg-6">
		                <div class="sm-wrapper" data-sortable-id="sm_form_elements_1">
		                    ...
		                    <div class="sm-box">
		                    	<form class="form-default" action="{{ action('ProjectTypeController@update', $projecttype->id) }}" method="post" enctype="multipart/form-data">
		                    	{{ csrf_field() }}
		                            ...
		                            <div class="row">
		                                <div class="col-12">
		                                    <div class="form-group">
		                                       ...
		                                       <input type="text" name="name" class="form-control" value="{{ $projecttype->name }}">
		                                    </div>
		                                </div>
		                            </div>
