...
<section id="main_content" class="bg slice-sm sct-color-1">
    <div class="container" id="container">
        ...
        <div class="breadcrumb-pageheader">
            ...
            <h6 class="sm-pagetitle--style-1 has_page_title">Add New Team Category Form</h6>
        </div>
		        ...
		        <div class="row">
		            <div class="col-lg-6">
		                <div class="sm-wrapper" data-sortable-id="sm_form_elements_1">
		                    ...
		                    <div class="sm-box">
		                    	<form  action="{{ action('TeamcategoryController@store') }}" method="post" enctype="multipart/form-data">
		                    	{{ csrf_field() }}
