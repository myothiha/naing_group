    ...
    <div class="container" id="container">
        ...
        <div class="breadcrumb-pageheader">
            <ol class="breadcrumb sm-breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Room Feature Form</li>
            </ol>
            <h6 class="sm-pagetitle--style-1 has_page_title">Edit Room Feature Form</h6>
        </div>
		        ...
		        <div class="row">
		            <div class="col-lg-6">
		                <div class="sm-wrapper" data-sortable-id="sm_form_elements_1">
		                    ...
		                    <div class="sm-box">
		                    	<form class="form-default" action="{{ action('RoomFeatureController@update', $roomFeature->id) }}" method="post" enctype="multipart/form-data">
		                    	{{ csrf_field() }}
		                            ...
		                            <div class="row">
		                                <div class="col-12">
		                                    <div class="form-group">
		                                       ...
		                                       <input type="text" name="name" class="form-control" value="{{ $roomFeature->name }}">
		                                    </div>
		                                </div>
		                            </div>
                                    ...
                                    <div class="row">
		                                <div class="col-12">
		                                    <div class="form-group">
		                                       ...
		                                       <input type="text" name="icon" class="form-control" value="{{ $roomFeature->icon }}">
		                                    </div>
		                                </div>
		                            </div>
