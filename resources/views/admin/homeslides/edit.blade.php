		        ...
		        <div class="row">
		            <div class="col-lg-6">
		                <div class="sm-wrapper" data-sortable-id="sm_form_elements_1">
		                    ...
		                    <div class="sm-box">
		                    	<form class="form-default" action="{{ action('HomeslideController@update', $homeslide->id) }}" method="post" enctype="multipart/form-data">
		                    	{{ csrf_field() }}
		                                ...
		                                <div class="col-12">
		                                    <div class="form-group">
		                                        ...
		                                        <input id="title" name="title1" placeholder="Enter First Title "
		                                               type="text" class="form-control" value="{{ $homeslide->title1 }}">
		                                    </div>
		                                </div>
		                            </div>
		                                ...
		                                <div class="col-lg-12">
		                                    <div class="form-group has-feedback">
		                                        ...
		                                        <input type="text" id="title" name="title2"
		                                               placeholder="Enter Second Title" class="form-control" value="{{ $homeslide->title2 }}">
		                                    </div>
		                                </div>
		                            </div>
		                            ...
		                            <div class="row">
		                                <div class="col-lg-12">
		                                    <div class="form-group has-feedback">
												...
												<input type="hidden" name="prev_image" value="{{ $homeslide->image }}">
		                                    </div>
		                                </div>
		                            </div>
