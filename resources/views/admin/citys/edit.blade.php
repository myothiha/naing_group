    ...
    <div class="container" id="container">
        ...
        <div class="breadcrumb-pageheader">
            <ol class="breadcrumb sm-breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit City Form</li>
            </ol>
            <h6 class="sm-pagetitle--style-1 has_page_title">Edit City Form</h6>
        </div>
		        ...
		        <div class="row">
		            <div class="col-lg-6">
		                <div class="sm-wrapper" data-sortable-id="sm_form_elements_1">
		                    ...
		                    <div class="sm-box">
		                    	<form class="form-default" action="{{ action('CityController@update', $city->id) }}" method="post" enctype="multipart/form-data">
		                    	{{ csrf_field() }}
