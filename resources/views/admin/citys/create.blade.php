    ...
    <div class="container" id="container">
        ...
        <div class="breadcrumb-pageheader">
            <ol class="breadcrumb sm-breadcrumb">
                <li class="breadcrumb-item"><a href="{{ action('CityController@index') }}">DataTable</a></li>
                <li class="breadcrumb-item active" aria-current="page">Add New City Form</li>
            </ol>
            <h6 class="sm-pagetitle--style-1 has_page_title">Add New City Form</h6>
        </div>
		                            ...
		                            <div class="row">
		                                <div class="col-12">
		                                    <div class="form-group">
		                                        ...
		                                        <input name="name" placeholder="Enter name of city "
