...
<section id="main_content" class="bg slice-sm sct-color-1">
    <div class="container" id="container">
        ...
        <div class="breadcrumb-pageheader">
            ...
            <h6 class="sm-pagetitle--style-1 has_page_title">DataTables Project Status</h6>
        </div>
        <!--END BREADCRUMB-->
                                    ...
                                    <?php $no=1; ?>
                                        @foreach($status as $data)
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td>{{ $data->name }}</td>
                                                <td>
                                                    <form action="{{action('ProjectStatusController@destroy',        $data->id) }}" method="Post">
                                                        <input type="hidden" name="_method" value="delete">
                                                        {{ csrf_field() }}
                                                        <a class="btn btn-warning" href="{{action('ProjectStatusController@edit',        $data->id) }}">Edit</a>
