...
<section id="main_content" class="bg slice-sm sct-color-1">
    <div class="container" id="container">
        ...
        <div class="breadcrumb-pageheader">
            ...
            <h6 class="sm-pagetitle--style-1 has_page_title">DataTables Team Category</h6>
        </div>
        <!--END BREADCRUMB-->
                            ...
                            <div class="sm-box">
                                ...
                                <div id="toolbar" style="margin-bottom: 10px;">
                                    <button id="remove" class="btn btn-warning">
                                        <i class="ion-ios-plus"></i><a href="{{ action('TeamcategoryController@create') }}"> Add New
                                    </a></button>
                                </div>
                                    ...
                                    <?php $no=1; ?>
                                        @foreach($teamcategorys as $teamcategory)
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td>
                                                    <form action="{{action('TeamcategoryController@destroy',        $teamcategory->id) }}" method="Post">
                                                        <input type="hidden" name="_method" value="delete">
                                                        {{ csrf_field() }}
                                                        <a class="btn btn-warning" href="{{action('TeamcategoryController@edit',        $teamcategory->id) }}">Edit</a>
